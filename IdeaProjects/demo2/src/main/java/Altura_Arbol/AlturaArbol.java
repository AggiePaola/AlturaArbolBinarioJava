...
public class AlturaArbol {
    ...
    public void crearArbolPredefinido() {
        ...
        // Nivel 5
        this.raiz.derecha.izquierda.derecha.izquierda = new Nodo(18);
        this.raiz.derecha.izquierda.derecha.derecha = new Nodo(19);
        this.raiz.izquierda.izquierda.izquierda.izquierda = new Nodo(14);
        this.raiz.izquierda.izquierda.izquierda.derecha = new Nodo(15);
        // Nivel 6
        this.raiz.izquierda.izquierda.izquierda.izquierda.izquierda = new Nodo(16);
        this.raiz.izquierda.izquierda.izquierda.izquierda.derecha = new Nodo(17);
        // Nivel 7
        this.raiz.izquierda.izquierda.izquierda.izquierda.izquierda.izquierda = new Nodo(18);
    }
    ...
    public static void main(String[] args) {
        AlturaArbol arbol = new AlturaArbol();
